    ...
    <div className="container mx-auto p-6 max-w-4xl">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">
          Personaliza qué notificaciones deseas recibir como propietario del sistema
        </p>
      </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-muted-foreground">
                  Recibe notificaciones cuando se solicita un turno en el sistema
                </p>
              </div>
              <Switch
                id="solicitud_turno"
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-muted-foreground">
                  Recibe notificaciones cuando se cancela un turno
                </p>
              </div>
              <Switch
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold">Notificaciones Administrativas</h3>

            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                <Label htmlFor="nuevo_empleado" className="text-base cursor-pointer">
                  Nuevo empleado registrado
                </Label>
                <p className="text-sm text-muted-foreground">
                  Recibe notificaciones cuando un nuevo profesional se registra en el sistema
                </p>
              </div>
              <Switch
                id="nuevo_empleado"
                checked={config.notificar_nuevo_empleado}
                onCheckedChange={() => handleToggle('notificar_nuevo_empleado')}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                <Label htmlFor="nuevo_cliente" className="text-base cursor-pointer">
                  Nuevo cliente registrado
                </Label>
                <p className="text-sm text-muted-foreground">
                  Recibe notificaciones cuando un nuevo cliente se registra en el sistema
                </p>
              </div>
              <Switch
                id="nuevo_cliente"
                checked={config.notificar_nuevo_cliente}
                onCheckedChange={() => handleToggle('notificar_nuevo_cliente')}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                <Label htmlFor="reporte_diario" className="text-base cursor-pointer">
                  Reporte diario
                </Label>
                <p className="text-sm text-muted-foreground">
                  Recibe un resumen diario de la actividad del sistema
                </p>
              </div>
              <Switch
                id="reporte_diario"
                checked={config.notificar_reporte_diario}
                onCheckedChange={() => handleToggle('notificar_reporte_diario')}
              />
            </div>
          </div>
