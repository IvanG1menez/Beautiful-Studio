              ...
              <CardHeader>
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex space-x-2">
                    ...
                    <Button
                      onClick={() => router.push('/dashboard-admin/clientes/nuevo')}
                            ...
                            <td className="py-4 px-4">
                              <div className="flex justify-end space-x-2">
                                <Button
                                  size="sm"
                                  variant="ghost"
                                  onClick={() => router.push(`/dashboard-admin/clientes/${cliente.id}`)}
                                >
              ...
              <CardHeader>
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex space-x-2">
                    ...
                    <Button
                      onClick={() => router.push('/dashboard-admin/profesionales/nuevo')}
                        ...
                        <CardContent className="space-y-2">
                          ...
                          <div className="flex space-x-2 pt-3">
                            <Button
                              ...
                              variant="outline"
                              className="flex-1"
                              onClick={() => router.push(`/dashboard-admin/profesionales/${empleado.id}`)}
                            >
