...
class NotificacionConfig(models.Model):
    ...
    notificar_pago_turno = models.BooleanField(
        default=True,
        help_text="Notificar cuando un cliente paga un turno"
    )
    notificar_cancelacion_turno = models.BooleanField(
        default=True,
        help_text="Notificar cuando un cliente cancela un turno"
    )
    notificar_modificacion_turno = models.BooleanField(
        default=True,
        help_text="Notificar cuando se modifica un turno"
    )
