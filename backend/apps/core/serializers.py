...
class PermisoAdicionalSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'activo', 'usuarios', 'total_usuarios',
...
class ConfiguracionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Configuracion
        fields = [
            'id', 'clave', 'valor', 'valor_parsed', 'descripcion',
            'tipo_dato', 'activo', 'created_at', 'updated_at'
        ]
        read_only_fields = ['id', 'created_at', 'updated_at']
    ...
    def validate_valor(self, value):
        ...
        if tipo_dato == 'int':
            ...
            if value.lower() not in ['true', 'false', '1', '0', 'yes', 'no']:
                raise serializers.ValidationError(
                    "El valor debe ser un booleano válido "
            ...
            try:
                ...
                raise serializers.ValidationError(
                    "El valor debe ser un JSON válido"
                )
...
class AuditoriaAccionesSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'usuario', 'usuario_username', 'accion',
            'accion_display', 'modelo_afectado', 'objeto_id',
