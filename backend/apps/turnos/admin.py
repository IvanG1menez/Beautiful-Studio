...
class HistorialTurnoInline(admin.TabularInline):
    ...
    extra = 0
    readonly_fields = ['usuario', 'accion', 'estado_anterior', 'estado_nuevo', 'observaciones', 'created_at']
    can_delete = False
...
class TurnoAdmin(admin.ModelAdmin):
    ...
    def cancelar_turnos(self, request, queryset):
        ...
        turnos_cancelables = queryset.exclude(estado__in=['completado', 'cancelado', 'no_asistio'])
        count = 0
